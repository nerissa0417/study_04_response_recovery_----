...
from supply_disruption_sim.disruption.supply_propagation import (
    derive_supplier_status_from_item_supply,
...
def reflect_supplier_statuses_from_items(state: SimState, model: ModelBundle) -> None:
    derive_supplier_status_from_item_supply(state=state, model=model)
