...
def _validate_auxiliary_foreign_keys(bundle: StandardBundle, report: ValidationReport) -> None:
    ...
    checks = [
        ...
        ("supplier_input_materials", bundle.supplier_input_materials, ["supplier_id"], ["item_id"]),
        ("supplier_purchased_materials", bundle.supplier_purchased_materials, ["supplier_id"], ["item_id"]),
...
def _validate_supply_map(bundle: StandardBundle, report: ValidationReport) -> None:
    current_rows = bundle.supplier_item_map.loc[~bundle.supplier_item_map["is_backup"].astype(bool)]
